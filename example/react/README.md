# Khulnasoft `gotrue-js` example

## Setup

### With a Khulnasoft project
...
You can use third-party login providers like GitHub or Google. Refer to the [docs](https://khulnasoft.io/docs/guides/auth#third-party-logins) to learn how to configure these.
...
You can find a docker compose file for spinning up a [Gotrue server](https://github.com/khulnasoft/gotrue) in the [infra folder](../infra).
