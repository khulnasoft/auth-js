...
const khulnasoftURL = process.env.REACT_APP_KHULNASOFT_URL
const khulnasoftAnon = process.env.REACT_APP_KHULNASOFT_ANON_KEY

const auth = new AuthClient({
  url: `${khulnasoftURL}/auth/v1`,
  headers: {
    accept: 'json',
    apikey: khulnasoftAnon,
  },
})
